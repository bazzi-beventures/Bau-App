...
const MODULE_LABELS: Record<string, ModuleMeta> = {
  ...
  warranty:         { label: 'Garantiefälle',     desc: 'Mängelmeldungen zu abgeschlossenen Projekten als eigener Vorgang: Meldung, Frist zum Meldezeitpunkt, Entscheid (anerkannt, Kulanz, abgelehnt), Ursache und Lieferant. Reiter «Garantie» im Projekt; offene Fälle erscheinen im Aufgaben-Board. Die Fristen selbst stehen im Feature-Flag «Garantie: Fristen».', category: 'operativ' },
  ...
  feature_requests: { label: 'Wünsche & Roadmap', desc: 'Nutzer reichen in der Hilfe-Blase Wünsche ein und sehen auf der Roadmap, was schon angefragt ist und wie es steht («Brauchen wir auch» statt Doppelmeldung). Namen und Wortlaut bleiben im eigenen Betrieb; andere Betriebe sehen nur eine Zahl. Der Betreiber sortiert die Wünsche auf admin.werkora.ch.', category: 'ki' },
